...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        'fr': {
            ...
            'rating_text': '4.8/5 - 1,200+ téléchargements',
            'features_title': 'Fonctionnalités de l\'application',
            'app_feature1_title': 'Jeu solo contre l\'IA',
            'app_feature1_text': 'Affrontez des adversaires virtuels avec différents niveaux de difficulté.',
            ...
            'screenshot1_desc': 'Interface de jeu intuitive',
            'screenshot2_desc': 'Suivi des statistiques',
            ...
            'email_title': 'Email',
            'app_support_title': 'Support technique',
            'app_support_text': 'Via la section "Aide" dans l\'application',
            'projects_title': 'Mes autres projets',
            'project1_title': 'DiceMaster Pro',
            'project1_text': 'Une application complète pour les passionnés de jeux de dés avec plus de 20 jeux différents.',
            'project2_title': 'Marseille Quiz',
            'project2_text': 'Un jeu de quiz sur la ville de Marseille, son histoire et sa culture.',
            'project3_title': 'CodeKnight',
            'project3_text': 'Un jeu éducatif pour apprendre les bases de la programmation de manière ludique.',
            'privacy_title': 'Politique de confidentialité',
            'privacy_intro': 'Dernière mise à jour : 1er janvier 2023',
            ...
            'privacy_point8_text': 'Si vous avez des questions concernant cette politique de confidentialité, vous pouvez nous contacter à l\'adresse :',
            ...
            'copyright': '© 2023 Quarante-Deux Le Jeu. Tous droits réservés.'
        },
        'en': {
            'home': 'Home',
            'game': 'The Game',
            ...
            'rating_text': '4.8/5 - 1,200+ downloads',
            'features_title': 'App features',
            'app_feature1_title': 'Solo play against AI',
            'app_feature1_text': 'Face virtual opponents with different difficulty levels.',
            ...
            'screenshot1_desc': 'Intuitive game interface',
            'screenshot2_desc': 'Statistics tracking',
            ...
            'email_title': 'Email',
            'app_support_title': 'Technical support',
            'app_support_text': 'Via the "Help" section in the app',
            'projects_title': 'My other projects',
            'project1_title': 'DiceMaster Pro',
            'project1_text': 'A complete app for dice game enthusiasts with over 20 different games.',
            'project2_title': 'Marseille Quiz',
            'project2_text': 'A quiz game about the city of Marseille, its history and culture.',
            'project3_title': 'CodeKnight',
            'project3_text': 'An educational game to learn programming basics in a fun way.',
            'privacy_title': 'Privacy Policy',
            'privacy_intro': 'Last updated: January 1, 2023',
            ...
            'privacy_point8_text': 'If you have any questions about this privacy policy, you can contact us at:',
            'privacy_acceptance': 'By using the Quarante-Deux app, you agree to the terms of this privacy policy.',
            'follow_us': 'Follow us:',
            'copyright': '© 2023 Quarante-Deux Le Jeu. All rights reserved.'
        }
    };
